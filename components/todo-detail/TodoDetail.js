...
export default function todoDetail(props) {
  ...
  return (
    <div>
      ...
      <Field name='title' type='text' label='Titill:' defaultValue={data.title} onChange={onChange}/>
      ...
      <Field name='due' type='datetime-local' label='Klárast fyrir:' defaultValue={data.due}  onChange={onChange}/>
      <div className={css.todoDetail__field}>
